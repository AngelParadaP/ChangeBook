    ...
    <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm p-6 h-full overflow-y-auto custom-scrollbar">
       <div className="flex justify-between items-center mb-6">
         ...
         <button 
           ...
           className="flex items-center gap-2 px-4 py-2 bg-light-purple hover:bg-dark-purple text-white rounded-lg transition-colors font-medium">
           <Plus size={18} />
           Crear Comunidad
         </button>
       </div>
       ...
       <form onSubmit={handleSearch} className="mb-8">
          <div className="relative max-w-2xl">
             ...
             <input 
               ...
               className="w-full pl-12 pr-4 py-3 bg-gray-100 dark:bg-zinc-800 border-2 border-gray-200 dark:border-zinc-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-light-purple dark:focus:ring-dark-purple focus:border-light-purple dark:focus:border-dark-purple focus:bg-white dark:focus:bg-zinc-900 transition-all text-gray-800 dark:text-gray-200"
             />
       ...
       {searching ? (
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {currentCommunities.map((community) => (
               <div key={community.id} className="border border-gray-200 dark:border-zinc-700 rounded-xl p-4 hover:shadow-md hover:border-light-purple/50 dark:hover:border-dark-purple/50 transition-all duration-200 flex flex-col justify-between group">
                  <div>
                      <div className="flex items-start gap-4 mb-3">
                      <div className="w-16 h-16 rounded-lg bg-gray-200 dark:bg-zinc-800 overflow-hidden relative flex-shrink-0 group-hover:ring-2 group-hover:ring-light-purple/30 transition-all">
                          {community.imageUrl ? (
       ...
       {showCreateModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
             <div className="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-md p-6 shadow-xl border border-gray-200 dark:border-zinc-700 max-h-[90vh] overflow-y-auto custom-scrollbar">
                 ...
                 <input 
                   className="w-full mb-3 px-4 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-light-purple" 
                 ...
                 <div className="mb-4">
                   ...
                   <input
                     ...
                     className="w-full mb-2 px-3 py-1.5 text-sm border border-gray-200 dark:border-zinc-700 rounded-lg bg-gray-50 dark:bg-zinc-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                   />
                   {/* Selected genres */}
                     ...
                     <div className="flex flex-wrap gap-1.5 mb-2">
                       {newCommunityGenres.map((genre) => (
                         <button
                           ...
                           className="text-xs px-2.5 py-1 rounded-full font-medium bg-purple-500 text-white shadow-sm flex items-center gap-1 hover:bg-purple-600 transition-colors"
                         >
                           {genre}
                   ...
                   {newCommunityGenres.length > 0 && (
                     <p className="text-xs text-purple-500 mt-2">{newCommunityGenres.length} género(s) seleccionado(s)</p>
                   )}
                 </div>
                 ...
                 <div className="flex justify-end gap-3">
                     ...
                     <button 
                        ...
                        className="px-4 py-2 bg-light-purple text-white rounded-lg disabled:opacity-50 hover:bg-dark-purple transition-colors"
                     >
