                ...
                <div className="flex-1 min-w-0 flex flex-col h-full">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 mt-auto">
                    ...
                    {activeTab === "discover" && !community.isMember && community.similarityScore != null && community.similarityScore >= 0.5 && (
                      <span className="text-[10px] sm:text-[11px] bg-primary-soft/60 text-primary-dark px-2.5 py-0.5 rounded-[6px] dark:bg-primary-dark/30 dark:text-primary-muted font-medium flex items-center gap-1">
